...
const defaultExperiences = [
  { id: '1', title: { fr: 'Fondateur & CEO', en: 'Founder & CEO' }, company: 'My Satoshis', period: '2020 - Present', description: { fr: 'En tant que fondateur et CEO, Advaxe dirige la vision et la stratégie pour My Satoshis, se concentrant sur le développement d\'outils éducatifs dans l\'espace bitcoin.', en: 'As Founder and CEO, Advaxe leads the vision and strategy for My Satoshis, focusing on educational tools in the bitcoin space.' }, company_url: 'https://www.mysatoshis.bi/' },
  { id: '2', title: { fr: 'Directeur Général', en: 'Chief Executive Officer' }, company: 'LA TECH BURUNDI COMPANY', period: '2021 - Present', description: { fr: 'En tant que CEO, Advaxe conduit le leadership stratégique et l\'innovation, supervisant le développement commercial et les partenariats.', en: 'As CEO, Advaxe drives strategic leadership and innovation, overseeing business development and partnerships.' }, company_url: 'https://www.latechburundi.bi/' },
  { id: '3', title: { fr: 'Co-Fondateur & CTO', en: 'Co-Founder & CTO' }, company: 'Free Tech Institute', period: '2022 - Present', description: { fr: 'En tant que CTO et co-fondateur, il gère les opérations d\'équipe, supervise le développement web et dirige les stratégies de médias sociaux.', en: 'As CTO and Co-Founder, He manages team operations, oversees website development, and directs social media strategies.' }, company_url: 'https://freeti.org/' },
  ...
  { id: '5', title: { fr: 'IT Manager', en: 'IT Manager' }, company: 'EDI Burundi', period: '2024 - Present', description: { fr: 'Responsable de la création et gestion de sites web, planification stratégique et formation du personnel.', en: 'Responsible for website creation and management, strategic planning, and organizing training sessions.' }, company_url: null },
  { id: '6', title: { fr: 'Directeur Technique', en: 'Technical Director and IT Manager' }, company: 'Institute for Economics and Enterprises', period: '2025 - Present', description: { fr: 'Création et gestion du site web, planification stratégique et collective, documentation et manuels de formation.', en: 'Creation and management of the website, planning of strategic and collective plans, data visualization and documentation.' }, company_url: null },
];
